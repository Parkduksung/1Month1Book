...
class ChangeDeviceNameParser : StreamParser<ChangeDeviceNameResult> {

    override fun parse(inputStream: InputStream): Result<ChangeDeviceNameResult> {
        return inputStream.use {
            ...
            if (isSuccess) {
                return@use Result.success(ChangeDeviceNameResult())
            } else {
