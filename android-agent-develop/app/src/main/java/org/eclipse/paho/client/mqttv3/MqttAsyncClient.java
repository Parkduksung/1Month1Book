...
public class MqttAsyncClient implements IMqttAsyncClient {
     ...
     * @param executorService used for managing threads. If null no executor service is used.
     * @throws IllegalArgumentException if the URI does not start with "tcp://", "ssl://" or
     *                                  "local://"
     * @throws IllegalArgumentException if the clientId is null or is greater than 65535 characters
     *                                  in length
     ...
     * @param pingSender          Custom {@link MqttPingSender} implementation.
     * @param executorService     used for managing threads. If null no executor service is used.
     * @param highResolutionTimer used for providing time values for keepalive ping scheduling. If {@code null}, a default timer is used
     * @throws IllegalArgumentException if the URI does not start with "tcp://", "ssl://" or
     *                                  "local://"
     * @throws IllegalArgumentException if the clientId is null or is greater than 65535 characters
     *                                  in length
