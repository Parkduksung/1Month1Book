...
public class Net10 {
    ...
    public static int WS_PREPAD = WS_PREPAD_SIZE;
    ...
    static public void jniRelayClose(int channelId) {
        jniP2PClose(channelId + MAX_CHANNEL);
    }

    static public byte[] jniRelayRead(int channelId) {
        return jniP2PRead(channelId + MAX_CHANNEL);
    }

    static public boolean jniRelayWrite(byte[] data, int offset, int size, int channelId) {
        return jniP2PWrite(data, offset, size, channelId + MAX_CHANNEL);
    }

    static public String jniRelayGetChannelInfo(int channelId) {
        return jniP2PGetChannelInfo(channelId + MAX_CHANNEL);
    }
