 ...
 */
@TargetApi(16)
public class RsMediaProjectionStream implements ScreenStream {
    ...
    public RsMediaProjectionStream(Context context, @NotNull IRSPerm rsperm) {
    ...
    private int initEncoder() {
        if (mRsperm != null) {
            ...
            encoderVirtualDisplay.setVirtualDisplay(mRsperm);
