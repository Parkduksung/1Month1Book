...
public class LauncherUtilsForRecord  implements ILauncherUtils{
    ...
    public int getLauncherPID(final Context context, final boolean isFinShellChannel){
        int launcherPID = Utils.getPid(context.getPackageName() + File.separator + "lib" + File
                .separator +
                "liblauncher", null);
        return launcherPID > 0 ? launcherPID :LauncherUtils.INVALID_LAUNCHER;
    }
    ...
    public boolean executeLauncher(Context context, boolean enableInput){
        ...
        try {
            ...
            String launcherFile = String.format(Locale.ENGLISH, dataDir + "/lib/liblauncher%d.so",
